...
format:
  revealjs: 
    theme: [default, zurich2026-slides-clean.scss]
    width: 1422
    height: 805
    slide-number: true
    include-in-header: 
...
<https://barzurich2026.netlify.app/>
...
# `r fontawesome::fa("laptop-code", "white")` Time to think! {background-color="#82654f" transition="slide-in"}
